...
def run_solver_latent_stage(
    ...
    for start, end in tqdm(
        ...
        input_ids, attention_mask = pad_left_ids(batch_ids, pad_id=tokenizer.pad_token_id, device=device)
        input_embeds = embed_layer(input_ids)
        with torch.no_grad():
            generated = model.generate(
                inputs_embeds=input_embeds,
...
def main() -> None:
    ...
    planner_model = None
    tokenizer_planner = None
    
    refiner_model = None
    tokenizer_refiner = None
